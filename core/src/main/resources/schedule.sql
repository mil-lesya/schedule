...
create unique index auditory_auditory_number_uindex
...
create unique index group_schedule_group_id_uindex
  on group_schedule (group_id);

create unique index group_schedule_schedule_id_uindex
  on group_schedule (schedule_id);
